...
Frontend-features worden op de backend geconfigureerd onder `nl-portal.frontend. and  (env: `NLPORTAL_FRONTEND_*`) en door de frontend opgehaald via `GET /api/public/frontend`. Zie de [Deployment guide](../configuratie/deployment-guide.md#frontend-features) voor de toggles en eigenschappen.
