...
**Deze variant wordt uitgefaseerd.** Keycloak heeft de legacy token exchange als verouderd gemarkeerd en verwijdert hem in een toekomstige versie. Draai je Keycloak 26.2 of nieuwer, richt dan [Standard token exchange (v2)](keycloak-token-exchange-v2.md) in.
