package nl.nlportal.zaken.service
...
import nl.nlportal.zaken.TestHelper.testDocument
import nl.nlportal.zaken.TestHelper.testZaakDocument
...
class ZakenServiceTest {
    @Mock(answer = Answers.RETURNS_DEEP_STUBS)
    private lateinit var zakenClient: ZakenClient
    ...
    private lateinit var zakenConfigProperties: ZakenConfigProperties
    ...
    fun setUp() {
        ...
        zakenConfigProperties = ZakenConfigProperties().apply {
    ...
    fun `should return null when no roles found for user`() =
        runTest {
            ...
            // given
            whenever(zakenClient.zaakInformatieobjecten().get(any()).retrieve())
            ...
            // when
            val (document, content) = zakenService.getZaakDocumentContent(testZaakDocument.uuid, authentication)
