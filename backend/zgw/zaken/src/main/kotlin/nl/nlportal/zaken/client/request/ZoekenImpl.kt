...
class ZoekenImpl(val zakenClient: ZakenClient) : Zaken {
    override fun search(): SearchZaken {
        return SearchZoekenImpl(zakenClient)
    }
...
class SearchZoekenImpl(val zakenClient: ZakenClient) : SearchZaken {
    ...
    override suspend fun retrieve(): ResultPage<Zaak> {
        return this.zakenClient.webClient
            .post()
