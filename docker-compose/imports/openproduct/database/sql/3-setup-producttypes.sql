...
INSERT INTO public.producttypen_thema(id, uuid, gepubliceerd, aanmaak_datum, update_datum, naam, beschrijving,
                                      hoofd_thema_id)
VALUES (6, 'c79c9cd6-a5dd-459b-a15e-6506149ab9c3', true, now(), now(), 'Intern', 'Alleen voor T \\& A \\(Test\\) gebruik\\. Niet voor klanten', null),
...
/* add schema */
INSERT INTO public.producttypen_jsonschema(id, naam, schema)
VALUES (6, 'woonwagenstandplaatsdata', '{
  "type": "object",
...
/* add producttype translation */
INSERT INTO public.producttypen_producttypetranslation(id, language_code, naam, samenvatting, master_id)
VALUES (7, 'nl', 'GeneriekProduct', 'samenvatting translatie', 4),
...
/* update sequences for merged rows */
SELECT pg_catalog.setval('public.producttypen_thema_id_seq', 8, true);
SELECT pg_catalog.setval('public.producttypen_jsonschema_id_seq', 7, true);
SELECT pg_catalog.setval('public.producttypen_producttype_id_seq', 6, true);
SELECT pg_catalog.setval('public.producttypen_producttypetranslation_id_seq', 9, true);
SELECT pg_catalog.setval('public.producttypen_producttype_themas_id_seq', 5, true);
