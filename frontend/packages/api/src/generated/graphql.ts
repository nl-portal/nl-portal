...
export type Activiteit = {
  ...
  aanduidingWatMeeTeNemen?: Maybe<Scalars['String']['output']>;
  aantal: Scalars['Int']['output'];
  naamActiviteitsoort: Scalars['String']['output'];
};
...
export type AfspraakAdres = {
  __typename?: 'AfspraakAdres';
  adresregel1: Scalars['String']['output'];
  adresregel2: Scalars['String']['output'];
};

export type AfspraakDetail = {
  __typename?: 'AfspraakDetail';
  aanmeldkenmerkAlfanumeriek?: Maybe<Scalars['String']['output']>;
  activiteiten: Array<Activiteit>;
  afspraakIdentificatie: Scalars['ID']['output'];
  afspraakLocatie?: Maybe<AfspraakLocatie>;
  afspraakSoort: Scalars['String']['output'];
  contactInformatie: ContactInformatie;
  geplandAanvangsmoment: Scalars['String']['output'];
  geplandEindmoment: Scalars['String']['output'];
  onderwerp: Scalars['String']['output'];
  onlineAdres?: Maybe<Scalars['String']['output']>;
};

export type AfspraakLocatie = {
  __typename?: 'AfspraakLocatie';
  bezoekadres?: Maybe<AfspraakAdres>;
  naam: Scalars['String']['output'];
};

export type AfspraakOverzicht = {
  __typename?: 'AfspraakOverzicht';
  afspraakIdentificatie: Scalars['ID']['output'];
  geplandAanvangsmoment: Scalars['String']['output'];
  geplandEindmoment: Scalars['String']['output'];
  onderwerp: Scalars['String']['output'];
...
export type AfsprakenResultaat = {
  __typename?: 'AfsprakenResultaat';
  afspraken: Array<AfspraakOverzicht>;
...
export type ContactInformatie = {
  __typename?: 'ContactInformatie';
  adres: AfspraakAdres;
  emailadres: Scalars['String']['output'];
  naam: Scalars['String']['output'];
...
export type IdentificatieInput = {
...
export type Query = {
  ...
  getAfspraak?: Maybe<AfspraakDetail>;
  getAfspraken: AfsprakenResultaat;
...
export type QueryGetAfspraakArgs = {
  id: Scalars['ID']['input'];
};


export type QueryGetAfsprakenArgs = {
  identificaties: Array<IdentificatieInput>;
  tot?: InputMaybe<Scalars['String']['input']>;
  van?: InputMaybe<Scalars['String']['input']>;
};
...
export type GetAfspraakQuery = { __typename?: 'Query', getAfspraak?: { __typename?: 'AfspraakDetail', afspraakIdentificatie: string, afspraakSoort: string, onderwerp: string, geplandAanvangsmoment: string, geplandEindmoment: string, aanmeldkenmerkAlfanumeriek?: string | null, onlineAdres?: string | null, afspraakLocatie?: { __typename?: 'AfspraakLocatie', naam: string, bezoekadres?: { __typename?: 'AfspraakAdres', adresregel1: string, adresregel2: string } | null } | null, activiteiten: Array<{ __typename?: 'Activiteit', naamActiviteitsoort: string, aantal: number, aanduidingWatMeeTeNemen?: string | null }>, contactInformatie: { __typename?: 'ContactInformatie', naam: string, emailadres: string, telefoonnummer: string, adres: { __typename?: 'AfspraakAdres', adresregel1: string, adresregel2: string } } } | null };

export type GetAfsprakenQueryVariables = Exact<{
  identificaties: Array<IdentificatieInput> | IdentificatieInput;
  van?: InputMaybe<Scalars['String']['input']>;
  tot?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetAfsprakenQuery = { __typename?: 'Query', getAfspraken: { __typename?: 'AfsprakenResultaat', totalCount: number, afspraken: Array<{ __typename?: 'AfspraakOverzicht', afspraakIdentificatie: string, onderwerp: string, geplandAanvangsmoment: string, geplandEindmoment: string }> } };
...
export const GetAfspraakDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetAfspraak"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getAfspraak"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"afspraakIdentificatie"}},{"kind":"Field","name":{"kind":"Name","value":"afspraakSoort"}},{"kind":"Field","name":{"kind":"Name","value":"onderwerp"}},{"kind":"Field","name":{"kind":"Name","value":"geplandAanvangsmoment"}},{"kind":"Field","name":{"kind":"Name","value":"geplandEindmoment"}},{"kind":"Field","name":{"kind":"Name","value":"aanmeldkenmerkAlfanumeriek"}},{"kind":"Field","name":{"kind":"Name","value":"onlineAdres"}},{"kind":"Field","name":{"kind":"Name","value":"afspraakLocatie"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"naam"}},{"kind":"Field","name":{"kind":"Name","value":"bezoekadres"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"adresregel1"}},{"kind":"Field","name":{"kind":"Name","value":"adresregel2"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"activiteiten"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"naamActiviteitsoort"}},{"kind":"Field","name":{"kind":"Name","value":"aantal"}},{"kind":"Field","name":{"kind":"Name","value":"aanduidingWatMeeTeNemen"}}]}},{"kind":"Field","name":{"kind":"Name","value":"contactInformatie"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"naam"}},{"kind":"Field","name":{"kind":"Name","value":"emailadres"}},{"kind":"Field","name":{"kind":"Name","value":"telefoonnummer"}},{"kind":"Field","name":{"kind":"Name","value":"adres"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"adresregel1"}},{"kind":"Field","name":{"kind":"Name","value":"adresregel2"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetAfspraakQuery, GetAfspraakQueryVariables>;
export const GetAfsprakenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetAfspraken"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"identificaties"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"IdentificatieInput"}}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"van"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tot"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getAfspraken"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"identificaties"},"value":{"kind":"Variable","name":{"kind":"Name","value":"identificaties"}}},{"kind":"Argument","name":{"kind":"Name","value":"van"},"value":{"kind":"Variable","name":{"kind":"Name","value":"van"}}},{"kind":"Argument","name":{"kind":"Name","value":"tot"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tot"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"afspraken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"afspraakIdentificatie"}},{"kind":"Field","name":{"kind":"Name","value":"onderwerp"}},{"kind":"Field","name":{"kind":"Name","value":"geplandAanvangsmoment"}},{"kind":"Field","name":{"kind":"Name","value":"geplandEindmoment"}}]}},{"kind":"Field","name":{"kind":"Name","value":"totalCount"}}]}}]}}]} as unknown as DocumentNode<GetAfsprakenQuery, GetAfsprakenQueryVariables>;
...
export type OgoneFormField = { __typename?: 'OgoneFormField'; name: string; value: string; };
export type OgonePayment = { __typename?: 'OgonePayment'; formAction: string; formFields: Array<OgoneFormField>; };
...
export type GenerateOgonePaymentMutation = { __typename?: 'Mutation'; generateOgonePayment: { __typename?: 'OgonePayment'; formAction: string; formFields: Array<{ __typename?: 'OgoneFormField'; name: string; value: string; }>; }; };
